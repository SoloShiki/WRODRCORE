#!/usr/bin/env python3
#Codigo para detectar fuego o cigarrillos usando Edge Impulse y enviar alertas via MQTT desde la RPI_1 a FIREVOLX 
import subprocess
import threading
import json
import time
...
# ---------- CONFIGURACIÓN ----------
BROKER_IP = "192.168.1.204" #Cambiar por la IP del broker MQTT
BROKER_PORT = 1883
...
# --- MODIFICADO ---
DESIRED_LABELS = {"cigar", "fireball"} 
THRESHOLD = 0.90
# ------------------
HEARTBEAT_INTERVAL = 5   # manda OK cada 1 segundo
